...
function archivingEvent(client, event_id, guild_id, title, description, date, heure) {
    try {
        ...
        createInfoLog(client, `L'event avec l'id ${event_id} a bien été archivé.`, "modules/cloturer-event.js", "null")
    } catch (error) {
        createErrorLog(client, `L'archivage de l'event avec l'id ${event_id} a échoué.`, "modules/cloturer-event.js", "null")
    }
