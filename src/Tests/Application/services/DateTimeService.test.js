...
describe('DateTimeService', () => {
    ...
    describe('isValidDateTime', () => {
        ...
        it('should reject invalid date and hour formats', () => {
            const invalidCases = [
                { date: '2024.01.15', hour: '15h00' }, // wrong date format
                { date: '15/01/2024', hour: '15.00' }, // wrong hour format
                { date: '15/1/2024', hour: '15h00' }, // missing leading zero
                { date: '15/13/2024', hour: '24h00' }, // invalid month
            ];
        ...
        const invalidCases = [
            { date: '2024-01-15', hour: '15h00' }, // wrong date format
            { date: '15/01/2024', hour: '15:00' }, // wrong hour format
            { date: '15-01-2024', hour: '15h00' }, // wrong date separators
            { date: '15/13/2024', hour: '24h00' }, // invalid month
        ];
