...
const Guild = require('../src/Infrastructure/models/Guild.js')(sequelize, Sequelize);
const User = require('../src/Infrastructure/models/User.js')(sequelize, Sequelize);
const Setting = require('../src/Infrastructure/models/Setting.js')(sequelize, Sequelize);
const Choice = require('../src/Infrastructure/models/Choice.js')(sequelize, Sequelize);
const Event = require('../src/Infrastructure/models/Event.js')(sequelize, Sequelize);
const GuildMember = require('../src/Infrastructure/models/GuildMember.js')(sequelize, Sequelize);
const GuildSetting = require('../src/Infrastructure/models/GuildSetting.js')(sequelize, Sequelize);
const UserEventChoice = require('../src/Infrastructure/models/UserEventChoice.js')(sequelize, Sequelize);
